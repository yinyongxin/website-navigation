...
const WebsitesNavigationBlock = () => {
	return (
		<Base
			class={
				"hover:scale-105 shadow-none hover:shadow-none hover:border-none bg-transparent hover:bg-none duration-300 bg-gradient-to-br from-primary/20 via-accent/20 to-secondary/20"
			}
		>
			...
			<div class="absolute border border-base-300 inset-0 flex flex-col justify-center gap-3 items-center duration-200 backdrop-blur bg-white/20 rounded-3xl opacity-100 group-hover:opacity-0">
				<div>HOVER</div>
				<div>FOR</div>
				<div>WEBSITWS</div>
			</div>
