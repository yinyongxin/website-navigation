			...
			<div class="w-full relative rounded-full overflow-hidden shadow">
				...
				<div class="absolute right-2 bottom-2 top-2 group">
					...
					>
						...
						<div class="w-full h-full rotate-45 absolute left-[32%] top-[32%] bg-base-content group-hover:-left-[100%] group-hover:-top-[100%] duration-1000"></div>
						<div class="w-full h-full -rotate-45 absolute -left-[32%] -top-[32%] group-hover:left-[100%] group-hover:top-[100%] bg-base-content duration-1000"></div>
					</button>
				</div>
			</div>
			<div class="flex justify-between items-center">
